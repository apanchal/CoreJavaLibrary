...
public class CriteriaExpression implements Criteria {
     ...
     *            expression.
     */
    public CriteriaExpression(final Criteria term, int operator, CriteriaExpression expression) {
        this(term);
     ...
     *            expression.
     * 
     * @see com.nividous.library.sqlquerybuilder.criteria.Criteria#write(com.nividous.library.sqlquerybuilder.util.Output)
     */
    @Override
