...
public abstract class LibraryException extends Exception {
     ...
     */
    public LibraryException(String theMessage) {
        super(theMessage);
     ...
     * NividousException exception should only be thrown by BusinessInsight.
     */
    public LibraryException(String message, Throwable internalException) {
        this(message);
    ...
    /**
     * Return the internal native exception. INClever BIs frequently catches
     * Java exceptions and wraps them in its own exception classes to provide
     * more information. The internal exception can still be accessed if
     * required.
     */
    ...
    /**
     * Allows overriding of INCLEVERS's exception chaining detection.
     * 
     * @param booleam
    ...
    private String logIfSQLException(Throwable originalEx) {
        ...
        while (cause != null) {
            ...
            if (SQLException.class.isAssignableFrom(rootCause.getClass())) {
                ...
                buffer.append(SystemPropertiesPool.getLineSeparator()).append(getIndentationString())
                        ...
                        .append(getIndentationString()).append(ExceptionMessageGenerator.getHeader("SQLSTATEHeader"))
                        .append(sqle.getSQLState()).append(SystemPropertiesPool.getLineSeparator())

                        .append(getIndentationString()).append(ExceptionMessageGenerator.getHeader("SQLMessageHeader"))
                        .append(sqle.getMessage()).append(SystemPropertiesPool.getLineSeparator());
            }
