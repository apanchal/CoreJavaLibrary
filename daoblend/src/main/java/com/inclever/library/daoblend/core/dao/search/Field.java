...
public class Field implements Serializable {
     ...
     * the empty string ("").
     */
    public static final String ROOT_ENTITY = StringPool.BLANK;
     ...
     * does not apply any operator to the column. All the result in the result
     * set are returned.
     */
     ...
     * result in the result set where the given property is non-null.
     */
     ...
     * given property in all result of the result set.
     */
