...
public class Search implements IMutableSearch, Serializable {
    ...
    private boolean isConstructorExpressionJPQL;

    private String constructorExpressionObjectName;
    ...
    public String getConstructorExpressionClass() {
        return constructorExpressionObjectName;
    }

    public boolean isConstructorExpressionQuery() {
        return isConstructorExpressionJPQL;
    }
    ...
    public boolean equals(Object obj) {
        return SearchUtil.searchEquals(this, obj);
    }
    ...
    public IMutableSearch setConstructorExpressionClass(String constructorExpressionObjectName) {
        if (constructorExpressionObjectName != null && !constructorExpressionObjectName.isEmpty()) {
            isConstructorExpressionJPQL = true;
            this.constructorExpressionObjectName = constructorExpressionObjectName;
        }
        return this;
    }
