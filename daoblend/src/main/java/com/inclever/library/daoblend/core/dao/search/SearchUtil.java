...
import static com.inclever.library.daoblend.core.dao.search.ISearch.RESULT_ARRAY;
import static com.inclever.library.daoblend.core.dao.search.ISearch.RESULT_AUTO;
import static com.inclever.library.daoblend.core.dao.search.ISearch.RESULT_LIST;
import static com.inclever.library.daoblend.core.dao.search.ISearch.RESULT_MAP;
import static com.inclever.library.daoblend.core.dao.search.ISearch.RESULT_SINGLE;
...
public final class SearchUtil {
	...
	// Since we're returning an object, we will never be able to return a
	// primitive value.
	...
	if (String.class.equals(type)) {
		...
		throw new ClassCastException("Unable to convert value "
			+ value.toString() + " to type Class");
	    }
	}
	...
	if (property == null || "".equals(property)) {
	    // null properties do nothing, don't bother to add them.
	    return;
	}
    ...
    public static boolean searchEquals(ISearch search, Object obj) {
	if (search == obj) {
	    return true;
	}
	...
	sb.append(")\n[first: ").append(search.getFirstResult());
