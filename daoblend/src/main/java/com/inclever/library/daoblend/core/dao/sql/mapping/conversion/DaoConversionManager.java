 ...
 * 
 * Contributors:
 *     Ashish Panchal - 2.0 - initial implementation
 ******************************************************************************/
...
/**
 * <p>
 * <b>Purpose</b>: Contains the conversion routines for some common classes in
 * the system. Primarily used to convert objects from a given database type to a
 * different type in Java. Uses a singleton instance, this is also used from the
 * platform.
 * <p>
...
public class DaoConversionManager extends DaoCoreConversionManager implements
     ...
     * 
     */
    private static final long serialVersionUID = 6024555961913610186L;

    protected Map defaultNullValues;

    /**
     * This flag is here if the Conversion Manager should use the class loader
     * on the thread when loading classes.
     */
    protected boolean shouldUseClassLoaderFromCurrentThread = false;

    protected static DaoConversionManager defaultManager;

    /**
     * Allows the setting of a global default if no instance-level loader is
     * set.
     */
    ...
    /**
     * Build a valid instance of Boolean from the source object. 't', 'T',
     * "true", "TRUE", 1,'1' -> Boolean(true) 'f', 'F', "false", "FALSE", 0 ,'0'
     * -> Boolean(false)
     */
    ...
    /**
     * Build a valid instance of a byte array from the given object. This method
    ...
    /**
     * Build a valid instance of java.util.Calendar from the given source
     * object.
     * 
     * @param sourceObject
     ...
     * 
     * @param sourceObject
     *            Object of type String or Number.
    ...
    /**
     * INTERNAL: Build a valid BigDecimal instance from a String or another
     * Number instance. BigDecimal is the most general type so is must be
     * returned when an object is converted to a number.
     * 
    ...
    /**
     * INTERNAL: Build a valid Short instance from a String or another Number
     * instance.
     * 
    ...
    /**
     * INTERNAL: Build a valid instance of java.sql.Time from the given source
     * object.
     * 
     * @param sourceObject
    ...
    /**
     * INTERNAL: Build a valid instance of java.sql.Timestamp from the given
     * source object.
     * 
     * @param sourceObject
    ...
    /**
     * INTERNAL: Build a valid instance of java.net.URL from the given source
     * object.
     * 
     * @param sourceObject
    ...
    /**
     * INTERNAL: Build a valid instance of java.util.Date from the given source
     * object.
     * 
     * @param sourceObject
     *            Valid instance of java.util.Date, String, java.sql.Timestamp,
    ...
    /**
     * PUBLIC: Resolve the given String className into a class using this
     ...
     * This should not be used for conversion under the session context, these
     * must go through the platform. This allows for the singleton to be
    ...
    /**
     * INTERNAL: Allow for the null values for classes to be defaulted in one
     * place. Any nulls read from the database to be converted to the class will
    ...
    /**
     * INTERNAL: Load the class using the default managers class loader. This is
     * a thread based class loader by default. This should be used to load all
     * classes as Class.forName can only see classes on the same classpath as
     * the eclipselink.jar.
     */
     ...
     * INTERNAL: Allow for the null values for classes to be defaulted in one
     * place. Any nulls read from the database to be converted to the class will
     * be given the specified null value. Primitive null values should be set to
     * the wrapper class.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * INTERNAL: Set the default class loader to use if no instance-level loader
     * is set
     * 
     * @parameter java.lang.ClassLoader
     */
    ...
    /**
     * INTERNAL: Get the default class loader to use if no instance-level loader
     * is set
     * 
    ...
    /**
     * ADVANCED: This flag should be set if the current thread classLoader
     * should be used. This is the case in certain Application Servers were the
     * class loader must be retrieved from the current Thread. If
    ...
    /**
     * PUBLIC: Return the list of Classes that can be converted to from the
     * passed in javaClass.
     * 
     * @param javaClass
     *            - the class that is converted from
    ...
    /**
     * PUBLIC: Return the list of Classes that can be converted from to the
     * passed in javaClass.
     * 
     * @param javaClass
