...
public class DAOBlendAccessExceptionResource extends ListResourceBundle {
    ...
    private static final Object[][] contents = {
            { String.valueOf(NULL_ENTITY_ERROR), "Cannot execute any CRUD operation on null entity object." },
            { String.valueOf(ENTITY_SAVE_ERROR), "Cannot persist Entity class [{0}], due to an internal error {1}." },
            { String.valueOf(SINGLE_ENTITY_FIND_ERROR), "Cannot find Entity class [{0}] with persistent id # {1}." },
            { String.valueOf(MULTI_ENTITY_FIND_ERROR), "Cannot list entities for Entity class [{0}]" },
            ...
            { String.valueOf(INCORRECT_DATE_FORMAT), "Incorrect date format: [{0}] (expected [YYYY-MM-DD])" },
            ...
            { String.valueOf(INCORRECT_TIME_FORMAT), "Incorrect time format: [{0}] (expected [HH:MM:SS])" },
